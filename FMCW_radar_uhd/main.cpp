...
int UHD_SAFE_MAIN(int argc, char* argv[]) {
    ...
    //radar configuration
    std::string radar_config_file = "/home/david/Documents/CPSL_USRP_FMCW_Radar/FMCW_radar_uhd/Config_uhd_victim_400us_to_500us.json";
    //std::string radar_config_file = "/home/davidh/Documents/BlackBoxRadarAttacks/FMCW_radar_uhd/Config_uhd_100MHz.json";
    

    //fmcw config files
    std::string fmcw_config_file = "/home/david/Documents/CPSL_USRP_FMCW_Radar/FMCW_radar_uhd/Config_FMCW.json";
    ...
    if (type == "double" && cpufmt == "fc64"){
        FMCWHandler<double> fmcw_handler(fmcw_config,radar_config,true);
    }
    else if (type == "float" && cpufmt == "fc32")
    {
        FMCWHandler<float> fmcw_handler(fmcw_config,radar_config,true);
    }
    else{
